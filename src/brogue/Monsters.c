                ...
                if (monst->status[i]) {
                    ...
                    if (!(monst->status[STATUS_IMMUNE_TO_FIRE])
                        ...
                        if (canSeeMonster(monst)) {
                            ...
                            messageWithColor(buf2, messageColorFromVictim(monst), TWO_SPEECH);
                        }
                        return;
                    }
                    if (monst->status[i] <= 0) {
                ...
                if (monst->status[i]) {
                    ...
                    if (monst->status[i] <= 0) {
                        ...
                        if (canSeeMonster(monst)) {
                            ...
                            messageWithColor(buf2, &white, TWO_SPEECH);
                        }
                        return;
                    }
                }
    ...
    if (closestMonster
        ...
        if (monst->xLoc == monst->targetCorpseLoc[0]
            ...
            if (canSeeMonster(monst)) {
                ...
                messageWithColor(buf, &goodMessageColor, TWO_SPEECH);
            }
    ...
    if (monst->xLoc == monst->targetCorpseLoc[0]
        ...
        if (--monst->corpseAbsorptionCounter <= 0) {
            ...
            if (canSeeMonster(monst)) {
                ...
                messageWithColor(buf, &advancementMessageColor, TWO_SPEECH);
            }
