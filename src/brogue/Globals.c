...
const monsterWords monsterText[NUMBER_MONSTER_KINDS] = {
    ...
    {"This infernal contraption spits blasts of flame at intruders.",
        ...
        {"pricks", {0}}},
    {"This trickster demon moves with astonishing speed, drawn magnetically to highly enchanted items, raw magic, and runics to steal from $HISHER enemies before blinking away.",
