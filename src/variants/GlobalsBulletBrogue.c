...
const blueprint blueprintCatalog_BulletBrogue[] = {
    ...
    {2, DEEPEST_LEVEL-1}, {15, 30},   15,      5,          0,                  (BP_VESTIBULE | BP_PURGE_INTERIOR | BP_OPEN_INTERIOR), {
    ...
    {2, DEEPEST_LEVEL-1}, {60, 100},  15,     6,          0,                  (BP_ROOM | BP_PURGE_INTERIOR | BP_SURROUND_WITH_WALLS | BP_OPEN_INTERIOR | BP_ADOPT_ITEM), {
...
itemTable potionTable_BulletBrogue[] = {
    ...
    {"hallucination",       itemColors[11], "", 10, 500,    0, 0, {75,75,0}, false, false, -1, false, "This flask contains a vicious and long-lasting fungal hallucinogen. Drinking this potion will make you hallucinate. Under its dazzling effect, you will wander through a rainbow wonderland, unable to discern the form of any creatures or items you see. Throwing this potion will create a luminescent fungal forest, which will block line of sight beyond it."},
