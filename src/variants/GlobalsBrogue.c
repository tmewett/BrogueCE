...
itemTable scrollTable_Brogue[] = {
    ...
    {"protect armor",       itemTitles[5], "",  10, 400,    0, 0, {0,0,0}, false, false, 1,  false, "This ceremonial shielding magic will permanently proof your equipped armor against degradation by acid and remove any curses on it."},
    {"protect weapon",      itemTitles[6], "",  10, 400,    0, 0, {0,0,0}, false, false, 1,  false, "This ceremonial shielding magic will permanently proof your equipped weapon against degradation by acid and remove any curses on it."},
