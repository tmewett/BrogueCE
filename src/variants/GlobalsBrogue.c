...
const blueprint blueprintCatalog_Brogue[] = {
    ...
    {5, AMULET_LEVEL}, {15, 30},   8,      5,          0,                  (BP_VESTIBULE | BP_PURGE_INTERIOR | BP_OPEN_INTERIOR), {
        ...
        {0,         0,          0,              {1,1},      1,          POTION,     POTION_HALLUCINATION, 0,    1,              0,          0,          (MF_GENERATE_ITEM | MF_BUILD_ANYWHERE_ON_LEVEL | MF_NOT_IN_HALLWAY | MF_ALTERNATIVE)},
        {0,         0,          0,              {1,1},      1,          POTION,     POTION_INVISIBILITY, 0,     1,              0,          0,          (MF_GENERATE_ITEM | MF_BUILD_ANYWHERE_ON_LEVEL | MF_NOT_IN_HALLWAY | MF_ALTERNATIVE)},
    ...
    {5, AMULET_LEVEL}, {60, 100},  10,     6,          0,                  (BP_ROOM | BP_PURGE_INTERIOR | BP_SURROUND_WITH_WALLS | BP_OPEN_INTERIOR | BP_ADOPT_ITEM), {
...
itemTable potionTable_Brogue[] = {
    ...
    {"hallucination",       itemColors[11], "", 10, 500,    0, 0, {300,300,0}, false, false, -1, false, "This flask contains a vicious and long-lasting fungal hallucinogen. Drinking this potion will make you hallucinate. Under its dazzling effect, you will wander through a rainbow wonderland, unable to discern the form of any creatures or items you see. Throwing this potion will create a luminescent fungal forest, which will block line of sight beyond it."},
