...
const blueprint blueprintCatalog_RapidBrogue[] = {
    ...
    {2, AMULET_LEVEL}, {15, 30},   8,      5,          0,                  (BP_VESTIBULE | BP_PURGE_INTERIOR | BP_OPEN_INTERIOR), {
    ...
    {2, AMULET_LEVEL}, {60, 100},  10,     6,          0,                  (BP_ROOM | BP_PURGE_INTERIOR | BP_SURROUND_WITH_WALLS | BP_OPEN_INTERIOR | BP_ADOPT_ITEM), {
